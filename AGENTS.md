...
Built on Codex CLI. Iron Man's JARVIS brought to life.
...
- `.Codex/skills/` — Accumulated expertise (frontend, voice, delivery)
...
8. **Skills:** Check `.Codex/skills/` before building anything from scratch.
...
- `.Codex/skills/frontend-master.md` — World-class CSS, animations, performance (2026)
- `.Codex/skills/voice-realtime.md` — Real-time voice AI, VAD, streaming TTS
- `.Codex/skills/delivery-system.md` — Parallel execution, quality gates, learning loop
